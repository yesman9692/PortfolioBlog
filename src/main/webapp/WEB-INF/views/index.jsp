    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#portfolio">History</a>
                </li>
...
<section class="page-section portfolio" id="portfolio">
    <div class="container">
        ...
        <div class="subject">
            ...
            <div class="subtitle">
                <h2 class="page-section-heading text-start text-uppercase text-secondary mb-0">🛠️SKILLS</h2>
                <br>
                <hr>
                <br>
            </div>
            <div class="article">
                <h4>📌Languages</h4>
                <h6 style="text-indent: 35px">Web Front-End</h6>
                <p style="text-indent: 40px" class="masthead-subheading font-weight-light mb-0 text-start">
                    HTML, CSS, Java Script, JSP, Thyme Leaf
                </p>
                <br>
                <h6 style="text-indent: 35px">Web Back-End</h6>
                <p style="text-indent: 40px" class="masthead-subheading font-weight-light mb-0 text-start">
                    JAVA, JPA
                </p>
                <br>
                <h6 style="text-indent: 35px">Others</h6>
                <p style="text-indent: 40px" class="masthead-subheading font-weight-light mb-0 text-start">
                    C, C++, Python
                </p>
                <br>
                ...
                <h4>📌Frameworks</h4>
                <h6 style="text-indent: 35px">Front-End</h6>
                <p style="text-indent: 40px" class="masthead-subheading font-weight-light mb-0 text-start">
                    Boot Strap
                </p>
                <br>
                <h6 style="text-indent: 35px">Back-End</h6>
                <p style="text-indent: 40px" class="masthead-subheading font-weight-light mb-0 text-start">
                    Spring Framework, Spring Boot, eGovFrame
                </p>
                <br>
                <h6 style="text-indent: 35px">DataBase</h6>
                <p style="text-indent: 40px" class="masthead-subheading font-weight-light mb-0 text-start">
                    MyBatis
                </p>
                <br>
                <br>
                <h4>📌Tools</h4>
                <h6 style="text-indent: 35px">VCS</h6>
                <p style="text-indent: 40px" class="masthead-subheading font-weight-light mb-0 text-start">
                    Git, Git-Gub, Bit Bucket
                </p>
                <br>
                <h6 style="text-indent: 35px">Collaboration Tools</h6>
                <p style="text-indent: 40px" class="masthead-subheading font-weight-light mb-0 text-start">
                    JIRA, Confluence
                </p>
                <br>
                <br>
                <h4>📌Other Dev Skills</h4>
                <h6 style="text-indent: 35px">Cloud</h6>
                <p style="text-indent: 40px" class="masthead-subheading font-weight-light mb-0 text-start">
                    Azure, AWS
                </p>
                <br>
                <h6 style="text-indent: 35px">Linux</h6>
                <p style="text-indent: 40px" class="masthead-subheading font-weight-light mb-0 text-start">
                    CentOS, Ubuntu
                </p>
                <br>
                <h6 style="text-indent: 35px">Embedded System</h6>
                <p style="text-indent: 40px" class="masthead-subheading font-weight-light mb-0 text-start">
